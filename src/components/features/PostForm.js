  ...
  return (
    <Form onSubmit={validate(handleSubmit)}>
      <Form.Group className="mb-3 w-50" controlId="formTitle">
        ...
        />
        {errors.title && <small className="d-block form-text text-danger mt-2"> This field is required and need min 3 characters.</small>}
      </Form.Group>
      <Form.Group className="mb-3 w-50" controlId="formAuthor">
        ...
        />
        {errors.author && <small className="d-block form-text text-danger mt-2"> This field is required and need min 3 characters.</small>}
      </Form.Group>    
      ...
      <Form.Group className="mb-3" controlId="formShortDescription">
        ...
        />
        {errors.shortDescription && <small className="d-block form-text text-danger mt-2"> This field is required and need min 20 characters.</small>}
      </Form.Group>
