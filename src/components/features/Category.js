...
const Category = () => {
    ...
    if(postData.length === 0) return <h2 className="text-center">There is no posts in this category.</h2>
    return ( 
       <>
        <h2>Category: {categoryName.charAt(0).toUpperCase() + categoryName.slice(1)}</h2>
