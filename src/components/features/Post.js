...
const Post = () => {
    ...
    return (
        ...
        <Modal show={showModal} onHide={handleClose}>
            ...
            <Modal.Body>
                <p>This operation will completely remove this from the app. Are you sure you want to do that?</p>
            </Modal.Body>
            <Modal.Footer>
        ...
        <Container>
            <Row xs={"auto"} className="justify-content-between mb-3">
                ...
                <Col>
                    <Button as={Link} to={"/post/edit/" + postData.id} variant="outline-info">Edit</Button>{' '}
